  ...
  return (
    ...
    <Section1App/>
      <Container>
        ...
        <Link to="/register" style={{ display: "flex", color: "Black", textAlign: "center", justifyContent: "center", margin: "5% 0% 10% 0%" }}>Si no tienes una cuenta puedes registrarte Aqui</Link>
      </Container>
    </>
  );
}
